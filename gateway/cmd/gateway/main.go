...
func main() {
	...
	PortInquiry := viper.GetString("PORTINQUIR")
	...
	HostInquiryV2 := viper.GetString("HOSTINQURIYV2")
	PortInquiryV2 := viper.GetString("PORTINQUIRV2")
	HostHistoryV2 := viper.GetString("HOSTHISTORYV2")
	PortHistoryV2 := viper.GetString("PORTHISTORYV2")
	HostTransferV2 := viper.GetString("HOSTTRANSFERV2")
	PortTransferV2 := viper.GetString("PORTTRANSFERV2")
	...
	var (
		...
		rpcinquiryInstance    = fs.String(HostAuth, HostInquiry+":"+PortInquiry, "Instance of Inquiry service")
		rpchistoryInstance    = fs.String(HostAuth, HostHistory+":"+PortHistory, "Instance of History service")
		rpctransferInstance   = fs.String(HostAuth, HostTransfer+":"+PortTransfer, "Instance of Transfer service")
		rpcinquiryv2Instance  = fs.String(HostAuth, HostInquiryV2+":"+PortInquiryV2, "Instance of InquiryV2 service")
		rpchistoryv2Instance  = fs.String(HostAuth, HostHistoryV2+":"+PortHistoryV2, "Instance of HistoryV2 service")
		rpctransferv2Instance = fs.String(HostAuth, HostTransferV2+":"+PortTransferV2, "Instance of TransferV2 service")
	)
